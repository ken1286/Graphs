...
# while len(traversalGraph) < len(roomGraph2):
testing = True
while len(traversalGraph) < len(roomGraph2):
    while stack.size() > 0:
...
# traversalGraph[lastRoomID]['s'] = player.currentRoom.id
# traversalGraph[player.currentRoom.id] = {}
# traversalGraph[player.currentRoom.id]['n'] = lastRoomID
